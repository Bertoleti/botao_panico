...
static EE_Page_TypeDef pages[512];
...
bool EE_Format(uint32_t numberOfPages)
{
  ...
  {
    pages[i].startAddress = (uint32_t *)(FLASH_SIZE - i * 512 - 512);
    pages[i].endAddress   = (uint32_t *)(FLASH_SIZE - i * 512 - 4);
  }  
